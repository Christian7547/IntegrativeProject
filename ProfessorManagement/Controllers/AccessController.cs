...
namespace ProfessorManagement.Controllers
{
    public class AccessController : Controller
    {
        ...
        //{
        //    //User user = userf;
        //    var query = _context.Users.Where(e=>e.Email==email).Where(p=>p.Password==password);
        ...
        {
            await HttpContext.SignOutAsync(CookieAuthenticationDefaults.AuthenticationScheme); //esta instruccion elimina la cookie
